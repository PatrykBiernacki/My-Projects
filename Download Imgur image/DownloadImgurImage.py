"""Program to download images from default gallery form IMGUR."""
...
def _download_image(image:object, title:str) -> None:
    ...
    try:
        ...
        with open(os.path.join(os.getcwd(), 'Gallery', f'{title[:20]}.{file_ext}'), 'wb') as saved_image:
...
def download_all_images_from_gallery(client:imgurpython.ImgurClient, download_folder:str = os.path.join(os.getcwd(), 'Gallery')) -> None:
